 ...
 *
 * The memory guard itself is not exercised here: PHP will not lower
 * memory_limit below what the test process has already allocated, so it cannot
 * be simulated in-process. The unreadable-file path below covers the same
 * failure route.
 */
